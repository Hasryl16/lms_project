...
class MaterialModel extends Model
{
    ...
    public function getMaterialWithModule($id)
    {
        return $this->select('materials.*, modules.title as module_title, courses.title as course_title')
                    ->join('modules', 'modules.id = materials.module_id', 'left')
    ...
    {
        return $this->select('materials.*, modules.title as module_title, modules.course_id')
                    ->join('modules', 'modules.id = materials.module_id', 'left')
